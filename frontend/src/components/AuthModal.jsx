      ...
      <div className="auth-modal-overlay" onClick={onClose}>
        <div className="auth-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="auth-modal-header">
            ...
            <p>Please configure Supabase environment variables to enable authentication.</p>
          </div>
    ...
    <div className="auth-modal-overlay" onClick={onClose}>
      <div className="auth-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="auth-modal-header">
          ...
          <p>{isSignUp ? 'Sign up to save your reviews' : 'Sign in to continue'}</p>
        </div>

        <div className="auth-social-buttons">
          <button className="auth-social-btn google" onClick={handleGoogleSignIn}>
          ...
          <button className="auth-social-btn github" onClick={handleGithubSignIn}>
